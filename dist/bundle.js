...
/***/ function(module, exports, __webpack_require__) {
	...
	function monthStartDate(month, year) {
	  var date = (0, _momentjs2.default)(month + ' ' + year).startOf('month');
	  return weekStartDate(date);
	};

	function monthEndDate(month, year) {
	  var date = (0, _momentjs2.default)(month + ' ' + year).endOf('month');
